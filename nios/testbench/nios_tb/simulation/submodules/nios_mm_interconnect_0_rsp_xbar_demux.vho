...
--synthesis_resources = 
 ...
 ENTITY  nios_mm_interconnect_0_rsp_xbar_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END nios_mm_interconnect_0_rsp_xbar_demux;

 ARCHITECTURE RTL OF nios_mm_interconnect_0_rsp_xbar_demux IS
 ...
 END RTL; --nios_mm_interconnect_0_rsp_xbar_demux
