...
alias com {
  ...
  vlog -sv "$QSYS_SIMDIR/nios_tb/simulation/submodules/mentor/altera_merlin_traffic_limiter.sv"                                                                      -work limiter                                                                          
  vlog -sv "$QSYS_SIMDIR/nios_tb/simulation/submodules/mentor/altera_avalon_st_pipeline_base.v"                                                                      -work limiter                                                                          
  ...
  vlog -sv "$QSYS_SIMDIR/nios_tb/simulation/submodules/mentor/altera_merlin_slave_agent.sv"                                                                          -work nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent         
  vlog -sv "$QSYS_SIMDIR/nios_tb/simulation/submodules/mentor/altera_merlin_burst_uncompressor.sv"                                                                   -work nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent         
  vlog -sv "$QSYS_SIMDIR/nios_tb/simulation/submodules/mentor/altera_merlin_master_agent.sv"                                                                         -work nios2_qsys_0_instruction_master_translator_avalon_universal_master_0_agent       
  vlog -sv "$QSYS_SIMDIR/nios_tb/simulation/submodules/mentor/altera_merlin_slave_translator.sv"                                                                     -work nios2_qsys_0_jtag_debug_module_translator                                        
  vlog -sv "$QSYS_SIMDIR/nios_tb/simulation/submodules/mentor/altera_merlin_master_translator.sv"                                                                    -work nios2_qsys_0_instruction_master_translator                                       
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS -L work -L work_lib -L rsp_xbar_mux -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux -L limiter -L id_router -L addr_router -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent -L nios2_qsys_0_instruction_master_translator_avalon_universal_master_0_agent -L nios2_qsys_0_jtag_debug_module_translator -L nios2_qsys_0_instruction_master_translator -L rst_controller -L irq_mapper -L mm_interconnect_0 -L pio_7 -L uart_0 -L pio_5 -L pio_4 -L pio_0 -L jtag_uart_0 -L onchip_memory2_0 -L nios2_qsys_0 -L nios_inst_pio_7_external_connection_bfm -L nios_inst_uart_0_external_connection_bfm -L nios_inst_pio_5_external_connection_bfm -L nios_inst_pio_4_external_connection_bfm -L nios_inst_pio_0_external_connection_bfm -L nios_inst_clk_bfm -L nios_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneive $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L rsp_xbar_mux -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux -L limiter -L id_router -L addr_router -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent -L nios2_qsys_0_instruction_master_translator_avalon_universal_master_0_agent -L nios2_qsys_0_jtag_debug_module_translator -L nios2_qsys_0_instruction_master_translator -L rst_controller -L irq_mapper -L mm_interconnect_0 -L pio_7 -L uart_0 -L pio_5 -L pio_4 -L pio_0 -L jtag_uart_0 -L onchip_memory2_0 -L nios2_qsys_0 -L nios_inst_pio_7_external_connection_bfm -L nios_inst_uart_0_external_connection_bfm -L nios_inst_pio_5_external_connection_bfm -L nios_inst_pio_4_external_connection_bfm -L nios_inst_pio_0_external_connection_bfm -L nios_inst_clk_bfm -L nios_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneive $TOP_LEVEL_NAME
}
